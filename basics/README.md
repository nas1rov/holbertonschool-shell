...
12) A script that prints the type of the file named iamafile. The file iamafile will be in the /tmp directory when we will run your script. (Note that depending on the file, the output of your script will be different)
